    ...
    <div class="bg-white border border-blue-200 rounded-2xl p-8">
        ...
        <form method="POST" action="{{ route('rendezvous.store') }}" class="space-y-1" id="form-rdv">
            ...
            <div id="bloc-date" class="hidden pb-5 pt-4 border-b border-blue-100">
                ...
                <div class="relative">
                    <svg class="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><rect x="3" y="4" width="18" height="18" rx="2" stroke-width="1.5"/><path d="M16 2v4M8 2v4M3 10h18" stroke-width="1.5" stroke-linecap="round"/></svg>
            ...
            <div id="bloc-motif" class="hidden pb-5 pt-4 border-b border-blue-100">
                ...
                <div class="relative">
                    <svg class="absolute left-3 top-3 w-4 h-4 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 12h6M9 16h4M5 8h14M5 4h14a1 1 0 011 1v14a1 1 0 01-1 1H5a1 1 0 01-1-1V5a1 1 0 011-1z"/></svg>
            ...
            {{-- ÉTAPE 6 : Informations médicales --}}
                ...
                heures.forEach(h => {
                    ...
                    if (h.disabled) {
                        ...
                        btn.addEventListener('click', function () {
                            ...
                            // Afficher motif + infos médicales + bouton
